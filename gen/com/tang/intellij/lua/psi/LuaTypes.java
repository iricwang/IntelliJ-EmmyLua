...
public interface LuaTypes {
  ...
  IElementType ATTRIBUTE = LuaParserDefinition.createType("ATTRIBUTE");
  ...
  IElementType EMPTY_STAT = LuaParserDefinition.createType("EMPTY_STAT");
  IElementType EXPR = LuaParserDefinition.createType("EXPR");
  IElementType EXPR_LIST = LuaParserDefinition.createType("EXPR_LIST");
  IElementType EXPR_STAT = LuaParserDefinition.createType("EXPR_STAT");
  ...
  IElementType LIST_ARGS = LuaParserDefinition.createType("LIST_ARGS");
  ...
  IElementType SINGLE_ARG = LuaParserDefinition.createType("SINGLE_ARG");
