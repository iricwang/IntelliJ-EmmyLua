...
public class LuaStructureViewFactory implements PsiStructureViewFactory {
    ...
    class LuaStructureViewModel extends StructureViewModelBase implements StructureViewModel.ElementInfoProvider {
        ...
        LuaStructureViewModel(PsiFile psiFile) {
    ...
    class LuaAlphaSorter implements Sorter {
        ...
        public Comparator<Object> getComparator() {
            return (o1, o2) -> {
                if (o1 instanceof LuaClassFieldElement && o2 instanceof LuaFuncElement) return -1;
                else if (o1 instanceof LuaFuncElement && o2 instanceof LuaClassFieldElement) return 1;
        ...
        public ActionPresentation getPresentation() {
            return new ActionPresentationData(
                    LuaBundle.message("action.sort.alphabetically"),
                    LuaBundle.message("action.sort.alphabetically_desc"),
